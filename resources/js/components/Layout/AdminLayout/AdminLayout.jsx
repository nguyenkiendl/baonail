...
function AdminLayout({ children }) {
    ...
    var initialItems = {
        ...
        post: {
            ...
            label: <Link to="/admin-panel/post-list">Bài viết</Link>,
            children: [
                {
                    key: "admin-panel/post-list",
                    label: (
                        <Link to="/admin-panel/post-list">
                            Danh sách bài viết
                        </Link>
                    ),
                },
                {
                    key: "admin-panel/new-post",
                    label: (
                        <Link to="/admin-panel/new-post">
                            Thêm bài viết mới
                        </Link>
                    ),
                },
                ...
                {
                    key: "admin-panel/category",
                    label: <Link to="/admin-panel/category">Danh mục</Link>,
                },
            ],
        },
    };
    ...
    useEffect(() => {
        if (userRole == "admin") {
            ...
            sideItems.push(initialItems.post);
